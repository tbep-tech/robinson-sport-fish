...
fish_images <- c("../FishImages/Snook.png","../FishImages/Red Drum.png","../FishImages/Tarpon.png")

receiver_plots <- ggplot() +
  geom_image(aes(x = 0, y = 1:3, image = fish_images),size = 0.5) +
  geom_text(aes(x = 0, y = 1:3-0.5, label = c("Common Snook","Red Drum", "Tarpon")), size = 6) +
