...
tagged <- acoustic %>%
  ...
  mutate(date_time = as_date(`Date and Time (UTC)`),
         station = ifelse(is.na(`Station Name`) | `Station Name` == "palm sola 2","Palma Sola 2",`Station Name`),
         station = ifelse(station == "palma sola #1","Palma Sola 1", station),
